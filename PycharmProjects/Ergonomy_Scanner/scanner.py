...
class Distance:
    ...
    def get_y_distance(self, pos1, pos2):
        return abs(abs(pos1[2]) - abs(pos2[2]))
...
class ScanErgonomy():
    ...
    def ergonomy_checker(self):
        ...
        if self.dist.get_y_distance(self.lmlist[24],self.lmlist[30]) <= 175 or self.dist.get_euclidian_distance(self.lmlist[23],self.lmlist[29]) <= 175:
